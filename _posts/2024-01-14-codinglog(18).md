...
<div style="text-align:center;">
    <img src="{{site.url}}/images/2024-01-14-codinglog(18)/image-20240114211406939.png" alt="image-20231230154210231" style="zoom:67%;" />
</div>
...
>
> main부에서 직접참조(&)를 안써서 보내면, 함수 구현부에서 일중역참조를 써주면 된다.
>
